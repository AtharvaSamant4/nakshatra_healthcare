...
export default function PatientMessagesPage() {
  const { identity, selectedUserId, role } = useApp()
  ...
  const handleSend = async () => {
    ...
    if (!text || !selectedUserId || !identity) return
    setSending(true)
    try {
    ...
    <AppLayout>
      <div className="mx-auto max-w-2xl space-y-4">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Chat with your assigned doctor</p>
        </div>
