import re
with open('frontend/app/patient/page.tsx', 'r', encoding='utf-8') as f: code = f.read()
insert_ui = '''
          {/* AI Adaptive Plan */}
          {adaptivePlan && (
...
'''
code, count = re.subn(r'(\s*\{/\* Active Prescriptions \*/\})', r'\n' + insert_ui + r'\1', code)
with open('frontend/app/patient/page.tsx', 'w', encoding='utf-8') as f: f.write(code)
print(count)
