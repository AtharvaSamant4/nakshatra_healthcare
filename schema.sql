...
-- ============================================================
-- AI Reports  (Feature 2 — generated by /api/ai/generate-report)
-- ============================================================
...
-- ============================================================
-- AI Recommendations  (Feature: Recommendation Engine)
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_ai_recommendations_patient ON ai_recommendations(patient_id, created_at DESC);
